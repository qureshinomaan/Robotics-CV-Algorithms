...
def make_cfg(settings):
    ...
    agent_cfg.action_space = {
        ...
        "look_anti": habitat_sim.agent.ActionSpec(
            "look_anti", habitat_sim.agent.ActuationSpec(amount=0.0)
        ),
        "look_clock": habitat_sim.agent.ActionSpec(
            "look_clock", habitat_sim.agent.ActuationSpec(amount=0.0)
        ),
...
#======================================================================================#
def update_v(V, sim):
    sim.config.agents[0].action_space['move_right'].actuation.amount = 1*V[0]
    sim.config.agents[0].action_space['move_left'].actuation.amount = 0
    
    sim.config.agents[0].action_space['move_up'].actuation.amount = -1*V[1]
    ...
    sim.config.agents[0].action_space['move_backward'].actuation.amount = -1*V[2]
    
    sim.config.agents[0].action_space['look_left'].actuation.amount = -1*V[4]
